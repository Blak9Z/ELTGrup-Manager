...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[radial-gradient(1400px_800px_at_15%_0%,rgba(32,162,210,0.22),transparent_55%),radial-gradient(900px_650px_at_100%_100%,rgba(26,132,171,0.22),transparent_50%),#060f1c] px-4">
      <section className="relative w-full max-w-md overflow-hidden rounded-3xl border border-[#2e4d72] bg-[linear-gradient(180deg,rgba(14,29,49,0.96),rgba(9,20,36,0.96))] p-6 shadow-[0_28px_80px_-32px_rgba(0,0,0,0.92)] sm:p-8">
        <div className="pointer-events-none absolute -right-16 -top-10 h-40 w-40 rounded-full bg-[rgba(109,175,238,0.2)] blur-3xl" />
